...
Further on in the analyis we will compare players with the highest maximum streaks and lead their leagues in a respective category. 
...
Finally, we look at how pace streakiness predicts total seasonal performance for both leagues. 
...
2. We also have a summary of their streaks to see what the likelihood of them continuing the streak might be.
