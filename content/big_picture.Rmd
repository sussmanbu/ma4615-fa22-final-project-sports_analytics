...
```{r conclusions}
library(knitr)
include_graphics('./segmented_plots/h_streak_distribution.png')
include_graphics('./segmented_plots/pts_streak_distribution.png')
```
...
```{r conclusions 2}
include_graphics('./segmented_plots/best_MLB_streaks.png')
include_graphics('./segmented_plots/AH_spike_plot.png')
include_graphics('./segmented_plots/top5_h_streak.png')

include_graphics('./segmented_plots/best_PRA_streaks.png')
include_graphics('./segmented_plots/JH_spike_plot.png')
include_graphics('./segmented_plots/top5_pts_streak.png')
```
