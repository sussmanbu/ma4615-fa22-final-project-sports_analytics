...
I feel like we can load/clean this data, because they’re all csv files, and don’t seem to have missing data anywhere. Some questions we want to address deal with trends in how hitters evolve over time: why is batting average down? Why do certain players get “hot” over others? What new trends are used to determine what players are valuable? I see some challenges trying to tie this one into our other potential datasets dealing with the NBA, as those deal with stats on a per game basis, whereas this one does not.
