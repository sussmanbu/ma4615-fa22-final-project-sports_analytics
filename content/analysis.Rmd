...
xlab('Date')
ggplot(scoring,aes(pts_streak))+stat_ecdf(geom = "step") + labs(title = 'OG Anunoby Streak Length CDF', x='Streak Length', y='CDF')
...
ylab('Points Deviated from Average') +
xlab('Date')
ggplot(scoring,aes(pts_streak))+stat_ecdf(geom = "step") + labs(title = 'Josh Hart Streak Length CDF', x='Streak Length', y='CDF')
...
geom_ribbon(aes(ymin=0, ymax=pmax(change_net,0)), fill="green", col="green", alpha=0.5) +
geom_point()+
geom_line(aes(y=0)) + ggtitle('Stephan Curry Deviation From Average (2022)') +
ylab('Points Deviated from Average') +
xlab('Date')
ggplot(scoring,aes(pts_streak))+stat_ecdf(geom = "step") + labs(title = 'Stephan Curry Streak Length CDF', x='Streak Length', y='CDF')
...
geom_ribbon(aes(ymin=0, ymax=pmax(change_net,0)), fill="green", col="green", alpha=0.5) +
geom_point()+
geom_line(aes(y=0)) + ggtitle('Yu Darvish Hits Deviated from Average') +
ylab('Hits Deviated from Average') +
xlab('Date')
