...
mod1 <-all_data %>% filter(player=='Josh Hart',season=='2022') %>%ungroup() %>% glm(formula=factor(pts_direction)~ts_pct+usg_pct+usg_pct:ts_pct,family=binomial())
mod1$coefficients
exp(mod1$coefficients)
summary(mod1)
