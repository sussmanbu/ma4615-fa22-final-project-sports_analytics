...
ylab('Points Deviated from Average') +
xlab('Date')
ggplot(scoring,aes(PRA_streak))+stat_ecdf(geom = "step") + labs(title = 'Stephan Curry Streak Length CDF', x='Streak Length', y='CDF')
