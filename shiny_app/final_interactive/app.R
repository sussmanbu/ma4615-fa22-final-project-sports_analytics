...
load( "bb_predicted.RData")
load( "so_predicted.RData")
load( "hr_predicted.RData")
load( "hit_predicted.RData")
load( "batting_real.RData")

load( "bb_paces.RData")
load( "so_paces.RData")
load( "hr_paces.RData")
load( "hit_paces.RData")

load(  "pts_predicted.RData")
load(  "ast_predicted.RData")
load(  "rb_predicted.RData")
load(  "scoring_real.RData")

load(  "pts_paces.RData")
load(  "ast_paces.RData")
load(  "rb_paces.RData")
