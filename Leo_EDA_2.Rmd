...
scoring<-all_data %>% filter(player == 'OG Anunoby',season == '2022') %>%select(change_net,game_date)
scoring<-all_data %>% filter(player == 'Cade Cunningham',season == '2022') %>%select(change_net,game_date)
scoring<-all_data %>% filter(player == 'Josh Hart',season == '2022') %>%select(change_net,game_date)
